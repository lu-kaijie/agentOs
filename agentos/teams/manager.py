...
from agentos.teams.mailbox import Mailbox, create_message
...
from agentos.teams.progress import TeammateProgress
from agentos.teams.registry import AgentNameRegistry
from agentos.teams.shared_task import SharedTaskStore
from agentos.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from agentos.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
