...
if TYPE_CHECKING:
    ...
    from agentos.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from agentos.agents.fork import ForkError, build_forked_messages
        from agentos.agents.parser import AgentDef
        from agentos.agents.tool_filter import resolve_agent_tools
        from agentos.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from agentos.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from agentos.agents.fork import ForkError, build_forked_messages
        from agentos.agents.parser import AgentDef
        from agentos.agents.tool_filter import build_teammate_tools
        from agentos.agent import Agent as AgentClass
        from agentos.conversation import ConversationManager
        from agentos.permissions import (
            DangerousCommandDetector,
        ...
        from agentos.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from agentos.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from agentos.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from agentos.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from agentos.client import create_client
        from agentos.config import ProviderConfig
