...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from agentos.tools.edit_file import EditFile
    from agentos.tools.file_state_cache import FileStateCache
    from agentos.tools.glob import Glob
    from agentos.tools.grep import Grep
