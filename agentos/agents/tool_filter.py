...
def build_teammate_tools(
    ...
    from agentos.tools.send_message import SendMessageTool
    from agentos.tools.task_create import TaskCreateTool
    from agentos.tools.task_get import TaskGetTool
    from agentos.tools.task_list import TaskListTool
    from agentos.tools.task_update import TaskUpdateTool
