...
PROJECT_AGENTS_DIR = ".agentos/agents"
USER_AGENTS_DIR = "~/.agentos/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("agentos.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from agentos.agents.parser import parse_frontmatter, _validate_agent_meta
