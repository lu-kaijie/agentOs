...
from agentos.skills.parser import SkillDef, substitute_arguments
from agentos.tools import ToolRegistry

if TYPE_CHECKING:
    from agentos.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from agentos.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
