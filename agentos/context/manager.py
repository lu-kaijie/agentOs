...
from agentos.serialization import build_messages
...
SESSION_SUBDIR = ".agentos/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from agentos.tools.base import StreamEnd, StreamEvent, TextDelta
